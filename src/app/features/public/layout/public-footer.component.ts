...
@Component({
  ...
  template: `
    <footer class="bg-surface-2 dark:bg-surface-3 border-t border-gray-200/60 dark:border-gray-800/60 text-gray-600 dark:text-gray-300 py-12 mt-auto transition-colors duration-300">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div class="col-span-1 md:col-span-1">
            <span class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white transition-colors duration-300">Waschly</span>
          ...
          <div>
            <h3 class="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider mb-4 transition-colors duration-300">{{ 'footer.company' | translate }}</h3>
            <ul class="space-y-3 text-sm">
              <li><a routerLink="/partner" class="hover:text-gray-900 dark:hover:text-white transition-colors duration-200">{{ 'footer.link_blog' | translate }}</a></li>
              <li><a href="#" class="hover:text-gray-900 dark:hover:text-white transition-colors duration-200">{{ 'footer.link_careers' | translate }}</a></li>
              <li><a href="#" class="hover:text-gray-900 dark:hover:text-white transition-colors duration-200">{{ 'footer.link_press' | translate }}</a></li>
            </ul>
          </div>
          <div>
